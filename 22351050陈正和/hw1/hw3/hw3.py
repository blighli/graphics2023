...
def render(ang):
    ...
    ambientLightColor0 = (0.1, 0.1, 0.1, 1.0)
    diffuseLightColor0 = (1.0, 0.0, 0.0, 1.0)
    specularLightColor0 = (1.0, 0.0, 0.0, 1.0)
    ambientLightColor1 = (0.1, 0.1, 0.1, 1.0)
    diffuseLightColor1 = (0.0, 0.0, 1.0, 1.0)
    specularLightColor1 = (0.0, 0.0, 1.0, 1.0)
...
def main():
    ...
    if not glfw.init():
        return
    window = glfw.create_window(640,640,'HW3', None,None)
    if not window:
        glfw.terminate()
        return
