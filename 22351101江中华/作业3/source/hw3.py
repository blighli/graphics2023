...
def main():
    ...
    modelf = Model("resources/objects/nanosuit/nanosuit.obj")
    # modelf = Model("resources/objects/cyborg/cyborg.obj")
    lamp_shader = Shader(CURDIR / "shaders/1.lamp.vs", CURDIR / "shaders/6.1.lamp.fs")
    ...
    light_settings = {
        "desert" : {
            ...
            "spot_color" : (.2, .2, .2),
            "point_colors" : [(1.0, 0.0, 0.0), (1.0, 0.6, 0.0), (1.0, 0.0, 0.0), (1.0, 0.6, 0.0)]
        },
        ...
        "factory" : {
            ...
            "direction_color" : (.4, .4, .4),
            "spot_color" : (.2, .2, .2),
            "point_colors" : [(.17, .17, .49), (.17, .17, .49), (.17, .17, .49), (.17, .17, .49)]
        },
        ...
        "horror" : {
            ...
            "spot_color" : (.2, .2, .2),
            "point_colors" : [(.3, .1, .1), (.3, .1, .1), (.3, .1, .1), (.3, .1, .1)]
        },
        ...
        "biochemical_lab" : {
            ...
            "direction_color" : (.4, .4, .4),
            "spot_color" : (.2, .2, .2),
            "point_colors" : [(0.4, 0.7, 0.1), (0.4, 0.7, 0.1), (0.4, 0.7, 0.1), (0.4, 0.7, 0.1)]
        },
    ...
    while not glfw.window_should_close(window):
        ...
        lighting_shader.set_vec3("dirLight.ambient", [0.5, 0.5, 0.5])
        lighting_shader.set_vec3("dirLight.diffuse", LIGHTS.get("direction_color"))
        ...
        lighting_shader.set_vec3("pointLights[0].ambient", [0.5, 0.5, 0.5])
        lighting_shader.set_vec3("pointLights[0].diffuse", LIGHTS.get("point_colors")[0])
        ...
        lighting_shader.set_vec3("pointLights[1].ambient", [0.5, 0.5, 0.5])
        lighting_shader.set_vec3("pointLights[1].diffuse", LIGHTS.get("point_colors")[1])
        ...
        lighting_shader.set_vec3("pointLights[2].ambient", [0.5, 0.5, 0.5])
        lighting_shader.set_vec3("pointLights[2].diffuse", LIGHTS.get("point_colors")[2])
        ...
        lighting_shader.set_vec3("pointLights[3].ambient", [0.5, 0.5, 0.5])
        lighting_shader.set_vec3("pointLights[3].diffuse", LIGHTS.get("point_colors")[3])
        ...
        lighting_shader.set_vec3("spotLight.ambient", [0.5, 0.5, 0.5])
        ...
        lighting_shader.set_mat4("model", modelm)

        modelf.draw(lighting_shader)
