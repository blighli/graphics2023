...
public class DefenceMagicBuff : Buff
{
    void Update()
    {
    ...
    public void launch()
    {
        gameObject.GetComponent<CharacterStats>().currentMagicDefence = (int)(gameObject.GetComponent<CharacterStats>().baseMagicDefence + PlusNumAll);
        ...
        for (int i = 0; i < targetBuffPanel.transform.childCount; i++)
        {
            ...
            if (buffGO.GetComponent<BuffIcon>().buffType == BuffType.MAGICDDEFENCE)
            {
