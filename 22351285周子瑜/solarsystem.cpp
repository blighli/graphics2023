...
void SolarSystem::addPlanet(std::string Name,float distanceFromSun, float orbitTime, float rotationTime, float radius, GLuint textureHandle)
{
	planets.push_back(Planet(Name, distanceFromSun, orbitTime, rotationTime, radius, textureHandle));
}
