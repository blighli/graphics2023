...
int main()
{
	...
	auto sphere_1 = core::primative::Sphere{ {0.0f, 0.0f, -1.0f}, 1.0f, 50, 50 };

	auto manager = core::resource::Text_Manager::instance();
	manager->load_texture("keqing", "keqing2.jpg");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		auto y_in_scene = (last_y - static_cast<float>(SCR_HEIGHT) * 0.5f) * height / SCR_HEIGHT;
