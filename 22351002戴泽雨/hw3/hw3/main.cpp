...
int main()
{
	...
	// main
	auto shader = core::shader::Shader("model_test_v.glsl", "model_test_f.glsl");
	...
	auto model1 = core::primative::Model{ "mario-lego/source/Mario lego5.obj" };
	...
	//light
	auto light1 = core::light::Point_Light{ {0.1f, 0.7f, 0.1f}, { 20.0f, 1.0f, 0.0f} };
	auto light2 = core::light::Point_Light{ {0.7f, 0.1f, 0.1f}, {-10.0f, 1.0f, 0.0f} };
	auto light_manager = core::light::Light_Manager{};
	light_manager.point_lights.push_back(light1);
	light_manager.point_lights.push_back(light2);
	...
	while (!glfwWindowShouldClose(window)) {
		...
		light_manager.setup_lights(shader);
		model1.draw(shader);
