...
public:
    ...
    void prepareToDraw()
    {
        if (!m_descPool)
        {
            ...
            poolSizes.push_back({VkDescriptorType::VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 8U});
        ...
        m_totalVertexCount = totalVertexData.size();

        {
            ...
            // m_materialBuffer = m_allocatorHandle.createBuffer(scopedBuffer, m_materials, VkBufferUsageFlagBits::VK_BUFFER_USAGE_STORAGE_BUFFER_BIT);
...
protected:
    ...
    std::vector<Camera> m_cameras = {Camera{}};
